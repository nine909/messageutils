...
public class BPMAValidator extends SMFMessageValidator {
	
	public BPMAValidator() {
		...
		this.addRule(AttributeCheckingModel.check(PathBPM.E01_PROVISION.getPath(), "resultcode", KEY_REQUIREMENT.FLAT_MANDATORY, null));
		this.addRule(AttributeCheckingModel.check(PathBPM.E01_PROVISION.getPath(), "description", KEY_REQUIREMENT.FLAT_MANDATORY, null));
